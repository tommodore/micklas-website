...
export default function TravelsPage({ params }: { params: { locale: string } }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-24">
      ...
      <div className="text-center mb-16">
        <div className="inline-block px-4 py-1 bg-brand-teal/10 text-brand-teal text-sm tracking-[3px] mb-4">PORTFOLIO</div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredDestinations.map((dest) => (
          <Link 
            key={dest.id} 
            href={`/${params.locale}/travels/${dest.slug}`}
