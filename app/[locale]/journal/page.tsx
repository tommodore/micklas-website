    ...
    <div className="max-w-6xl mx-auto px-6 py-24">
      ...
      {posts.length === 0 ? (
        <div className="text-center py-20">
          <p className="text-gray-500">No published stories yet. Check back soon!</p>
        </div>
      ) : (
            ...
            >
              <div className="relative h-80 bg-gray-100">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  <div className="text-sm opacity-75 mb-2">{new Date(post.publishDate).toLocaleDateString()}</div>
